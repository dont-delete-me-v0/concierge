...
- **Последовательно** запускает все crawler'ы из `crawl-configs/concert.ua/kyiv/`:
  - business (бізнес)
  - concerts (концерти)
  - dance (танці)
...
- **Продолжает** работу при ошибках в отдельных категориях
